    ...
    return (
        <div className="bg-background w-full min-h-screen p-4 py-8 lg:p-6 lg:h-screen">
            <div className="flex flex-col gap-3 lg:grid lg:grid-cols-6 lg:grid-rows-6 lg:gap-6 lg:h-full">
                ...
                <div className="col-start-3 col-span-2 row-start-3 row-span-2 bento-card flex flex-col justify-center gap-4">
                ...
                <div className="col-start-3 col-span-2 row-start-5 row-span-2 bento-card flex flex-col gap-4 overflow-hidden">
